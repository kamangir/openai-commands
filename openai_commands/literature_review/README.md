...
---
built by [`abcli-9.192.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.129.1`](https://github.com/kamangir/openai-commands).
