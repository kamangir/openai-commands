...
---
built by [`abcli-9.194.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.134.1`](https://github.com/kamangir/openai-commands).
