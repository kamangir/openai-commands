...
---
built by [`abcli-9.189.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.103.1`](https://github.com/kamangir/openai-commands).
