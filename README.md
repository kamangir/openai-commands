...
---
built by [`abcli-9.187.1-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.29.1`](https://github.com/kamangir/openai-commands).
