...
built by 🌀 [`blue_options-4.76.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.183.1`](https://github.com/kamangir/openai-commands).
