...
built by 🌀 [`blue_options-4.71.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on [`openai_commands-3.175.1`](https://github.com/kamangir/openai-commands).
